...
public class EstudianteService {
    ...
    public Estudiante findById(int id) {
        ...
        return estudianteRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("EL estudiante no existe"));
    }
    ...
    public void delete(int id) {
        if (!estudianteRepository.existsById(id)) throw new EntityNotFoundException("El estudiante no existe");
    ...
    public Estudiante findByNumeroLibreta(int numeroLibreta) {
        ...
        return estudianteRepository.findEstudianteByNumeroLibreta(numeroLibreta)
    ...
    public List<Estudiante> findAllByGenero(String genero) {
        return estudianteRepository.findEstudiantesByGenero(genero);
    }
}

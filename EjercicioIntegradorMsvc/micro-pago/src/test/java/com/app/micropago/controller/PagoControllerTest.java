...
import com.app.micropago.constant.Rol;
...
public class PagoControllerTest {
    ...
    @Test
    public void testGetTotalFacturado() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/pago/totalFacturado")
                        .contentType(MediaType.APPLICATION_JSON)
